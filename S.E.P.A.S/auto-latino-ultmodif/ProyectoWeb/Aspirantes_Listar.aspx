<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPager.Master" CodeBehind="Aspirantes_Listar.aspx.vb" Inherits="ProyectoWeb.Vehiculos_Listar" %>
                 ...
                 <asp:GridView ID="GdvColores" AutoGenerateColumns="false" CssClass="table table-active table-bordered" runat="server">--%>
                     ...
                     <Columns>
                           ...
                           <asp:TemplateField Visible="TRUE" HeaderText="Nombre">
                                 <ItemTemplate>
                                         <asp:Label ID="descripcion" runat="server" Text='<%# Eval("NOMBRE") %>' />
                                 </ItemTemplate>
                       </asp:TemplateField>
                            <asp:TemplateField Visible="TRUE" HeaderText="Apellido">
                                 <ItemTemplate>
                                          <asp:Label ID="TipoColor" runat="server" Text='<%# Eval("APELLIDO") %>' />
                                 </ItemTemplate>
                       </asp:TemplateField>

                           <asp:TemplateField Visible="TRUE" HeaderText="Dni">
                                 <ItemTemplate>
                                         <asp:Label ID="TipoAuto" runat="server" Text='<%# Eval("DNI") %>' />
                                 </ItemTemplate>
                       </asp:TemplateField>
                         
                            <asp:TemplateField Visible="TRUE" HeaderText="CE">
                                 <ItemTemplate>
                                          <asp:Label ID="TipoMarca" runat="server" Text='<%# Eval("CE") %>' />
                                 </ItemTemplate>
                       </asp:TemplateField>

                           <asp:TemplateField Visible="TRUE" HeaderText="Genero">
                                 <ItemTemplate>
                                         <asp:Label ID="TipoModelo" runat="server" Text='<%# Eval("GENERO") %>' />
                                 </ItemTemplate>
                       </asp:TemplateField>
                         
                            <asp:TemplateField Visible="TRUE" HeaderText="Curso">
                                 <ItemTemplate>
                                          <asp:Label ID="PrecioVenta" runat="server" Text='<%# Eval("CURSO") %>' />
                                 </ItemTemplate>
                       </asp:TemplateField>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <asp:TextBox ID="TxtCantidadIngreso" runat="server" Text="" CssClass="form-control"></asp:TextBox>
                    </div>--%>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>                   
